...
__SYSCALL_COMMON(442, sys_mount_setattr)
__SYSCALL_COMMON(444, sys_landlock_create_ruleset)
__SYSCALL_COMMON(445, sys_landlock_add_rule)
__SYSCALL_COMMON(446, sys_landlock_restrict_self)
